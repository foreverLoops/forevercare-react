      ...
      <htmlForm >
        ...
        <section>
                    <div className="info-details">
                        <span className="info-global"><label htmlhtml="name" >Name & Surname</label></span>
                            <input className="info" id ="name" name="Name" type="text" placeholder="e.g John Doe" required/>
                    </div>

                    <div className="info-details">
                        <span className="info-global"><label htmlFor="email" >Email</label></span>
                            <input  id="email" className="info" name="email" type="email" placeholder="example@gmail.com"/>
                    </div>

                    <div className="info-details">
                        <span className="info-global"><label htmlFor="phone" >Phone Number</label></span>
                            <input id="phone" className="info" name="phone" type="tel" placeholder="e.g 098-098-5674" required/>
                    </div>

                    <div className="info-details">
                        <span className="info-global"><label htmlFor="ID">Identification Number</label></span>
                            <input id="ID" className="info" name="ID" type="text" placeholder="e.g 19435763782894" maxlength="13" required/>
                    </div>

                    <div className="info-details">
                        <span className="info-global"><label  htmlFor="contact" >Contact Preference:</label></span>
                        <div className="radio01">
                            <div><label><input id="contact"  name="contact" type="radio"/> Phone</label></div>
                            <div><label><input  name="contact" type="radio"/> Email</label></div>
                        </div>
                    </div> 
            ...
            {/* <!-- This part is htmlFor the Medical appointments  --> */}
                ...
                <section className="appointment_info">
                    <h2>Medical Departments of <span className="heading-htmlForm"> Appointments</span></h2>
                    ...
                    <div className="app01">
                       <ul>
                        ...
                        <div className="info-other">
                            <textarea id="other"  rows="3" cols="0" placeholder="please specify"></textarea>
                        </div>
                    </div>
